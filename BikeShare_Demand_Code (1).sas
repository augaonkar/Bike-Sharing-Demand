...
datafile="C:\Program Files\Sas_Data\BikeShare.csv"
...
if season=4 	then fall=1; 		else fall=0;
...
if weather=4 	then hv_rain=1;		else hv_rain=0;
...
if week_day=7 	then sat=1;		else sat=0;
...
if hour=23 	then h23 = 1;	else h23=0;
run;
